...
/**
 * An operator asked to run a stopped process again from the beginning — from the UI, the REST API
 * or an MCP tool. Its sibling {@link RetryProcessRequested} picks it up where it stopped instead.
 *
 ...
 */
public record RestartProcessRequested(String processId) implements DomainEvent {
