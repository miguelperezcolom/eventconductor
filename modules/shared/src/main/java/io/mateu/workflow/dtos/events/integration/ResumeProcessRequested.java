...
/**
 * An operator asked to ResumeProcess — from the UI, the REST API or an MCP tool.
 *
 ...
 */
public record ResumeProcessRequested(String processId) implements DomainEvent {
