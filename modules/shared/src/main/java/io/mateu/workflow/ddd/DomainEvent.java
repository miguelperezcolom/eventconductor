...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = MessageSubscriptionChanged.class, name = "message-subscription-changed"),
        ...
        @JsonSubTypes.Type(value = RetryDueCheckRequested.class, name = "retry-due-check-requested"),
