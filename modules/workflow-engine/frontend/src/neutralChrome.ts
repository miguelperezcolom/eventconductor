...
/**
 * Design-system-neutral chrome for the shared "advanced" components (workflow editors, form
 ...
 * look — the same contract as <mateu-unsupported>.
 */
...
/** Sitemap / hierarchy (re-layout). */
export const iconSitemap = icon(svg`
