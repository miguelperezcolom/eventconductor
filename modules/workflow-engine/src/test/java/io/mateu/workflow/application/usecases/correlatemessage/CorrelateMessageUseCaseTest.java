...
class CorrelateMessageUseCaseTest {
    ...
    private Step messageStep(String messageName, String correlationExpression) {
        return new Step("s1", "wd-1", StepType.MESSAGE, "Wait for message", null, null, null, false, null, null, null, null, 0, null, messageName, correlationExpression, 0, 0, false, null, 0);
    }
    ...
    void ignoresNonMessageSteps() {
        var action = new Step("s1", "wd-1", StepType.ACTION, "Step", null, null, null, false, "t", null, null, null, 0, null, null, null, 0, 0, false, null, 0);
