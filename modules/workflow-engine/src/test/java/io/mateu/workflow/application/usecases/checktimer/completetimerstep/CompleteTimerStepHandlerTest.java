...
class CompleteTimerStepHandlerTest {
    ...
    private StepExecution pendingTimerSe(long durationMillis, String untilVariable, LocalDateTime startedAt, Variable... variables) {
        Step step = new Step("s1", "wd-1", StepType.TIMER, "Wait", null, null, null, false, null, null, null, null, durationMillis, untilVariable, null, null, 0, 0, false, null, 0);
    ...
    void skipsWhenStepIsNotATimer() {
        Step action = new Step("s1", "wd-1", StepType.ACTION, "Step", null, null, null, false, "t", null, null, null, 0, null, null, null, 0, 0, false, null, 0);
