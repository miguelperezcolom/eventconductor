...
class StepOverProcessUseCaseTest {
    ...
    private StepExecution se(String id, String stepId, StepType type, StepExecutionStatus status, int order) {
        Step step = new Step(stepId, "wd-1", type, stepId, null, null, null, false, "topic", "form-1", null, null, 0, 0, false, null);
    ...
    void parallelStepsAreAllStarted() {
        var process = process("p-1");
        Step step1 = new Step("s1", "wd-1", StepType.ACTION, "s1", null, null, null, true, "topic", null, null, null, 0, 0, false, null);
        Step step2 = new Step("s2", "wd-1", StepType.ACTION, "s2", null, null, null, true, "topic", null, null, null, 0, 0, false, null);
    ...
    void stepWithUnmetPreconditionStepIdIsNotStarted() {
        var process = process("p-1");
        Step prerequisite = new Step("prereq", "wd-1", StepType.ACTION, "prereq", null, null, null, false, "topic", null, null, null, 0, 0, false, null);
        Step dependent = new Step("dep", "wd-1", StepType.ACTION, "dep", null, "prereq", null, false, "topic", null, null, null, 0, 0, false, null);
