	...
	integrations: [
		starlight({
			...
			social: [
				...
				{ icon: 'discord', label: 'Discord', href: 'https://discord.gg/4vudTCheNc' },
			],
			sidebar: [
				{
				...
				},
				{
					...
					items: [
						...
						{ label: 'Task Contracts & Worker Protocol', slug: 'reference/task-contracts' },
						{ label: 'Maven Plugin (validate & generate)', slug: 'reference/maven-plugin' },
