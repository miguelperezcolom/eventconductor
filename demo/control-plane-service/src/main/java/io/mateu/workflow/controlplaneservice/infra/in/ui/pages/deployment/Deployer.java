...
public class Deployer implements Listing<DeploymentRow>, Searchable, Filterable<NoFilters> {
    ...
    @Override
    public ListingData<DeploymentRow> search(SearchRequest request, HttpRequest httpRequest) {
