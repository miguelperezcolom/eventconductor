...
public class ReleaseIdOptionsSupplier implements ForeignKeyOptionsSupplier {
    ...
    public ListingData<Option> search(String searchText, Pageable pageable, HttpRequest httpRequest) {
        ...
        return new ListingData<>(new Page<>(
                ...
                found.page().content().stream().map(release ->
                        new Option(release.id(), release.name())).toList()));
    }
}
