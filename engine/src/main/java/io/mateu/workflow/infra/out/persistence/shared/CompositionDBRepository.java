...
@Slf4j
public abstract class CompositionDBRepository<EntityType extends Entity<IdType>, ParentIdType, IdType> implements CompositionRepository<EntityType, ParentIdType, IdType> {
