...
@Slf4j
public abstract class CompositionDBCrudAdapter<EntityType extends Entity<IdType>, ParentIdType, IdType> implements CompositionCrudAdapter<EntityType, ParentIdType, IdType> {
